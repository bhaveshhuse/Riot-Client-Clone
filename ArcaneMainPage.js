...
box3[0].addEventListener('click', function (e) {
    if (video.muted) {
        if (video.paused) {
            document.getElementById("audiobtn").src = "icons8-no-audio-light-100.png";
        } else {
            video.muted = false;
            document.getElementById("audiobtn").src = "icons8-audio-light-100.png";
        }
    } else {
        video.muted = true;
        document.getElementById("audiobtn").src = "icons8-no-audio-light-100.png";
...
box3[0].addEventListener('mouseleave', function (e) {
    if (video.paused == true || video.muted == true) {
        document.getElementById("audiobtn").src = "icons8-no-audio-dark-100.png";
    } else {
        document.getElementById("audiobtn").src = "icons8-audio-dark-100.png";
    }
})
...
// Web series link
function webseries() {
    window.location.href = "https://www.netflix.com/in/title/81435684";
}

// Theme song link
function theme() {
    window.location.href = "https://www.youtube.com/watch?v=F5tSoaJ93ac";
}

// Official website link
function arcane() {
    window.location.href = "https://arcane.com/en-gb/";
}